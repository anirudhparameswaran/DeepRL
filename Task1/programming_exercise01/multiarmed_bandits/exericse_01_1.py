...
# 
avg_reward_eps, opt_eps, reg_eps = epsilon_greedy(multiArmedBandit , n, epsilon=0.2)
avg_reward_eps_tv, opt_eps_tv, reg_eps_tv = epsilon_greedy(multiArmedBandit, n, time_varying=True, delta = 1)
